...
import type {
  FansProfile, FansProfileAge, FansProfileCity, FansProfileDevice,
  FansProfileGender, FansProfileInterest, FansProfileProvince
} from "~src/columns/FansProfile";
import {Box} from "@mui/material";
import React from "react";

const PercentageSimple = ({value}: { value: number }) => {
...
function PercentageIndicator({name, value, index}: { name: string, value: number, index: number }) {
